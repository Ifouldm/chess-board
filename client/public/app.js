...
import { isPushNotificationSupported, initializePushNotifications, registerServiceWorker, getUserSubscription, createNotificationSubscription, } from './push-notifications.js';
// DOM elements
...
socket.on('initialState', (gameState, playerColour) => {
    if (gameState._id === gameId) {
        loading.style.display = 'none';
        colour = playerColour;
        if (colour === 'b')
            chessBoard.generateSquares('b');
