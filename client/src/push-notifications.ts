const pushServerPublicKey =
    'BL4eApB5vjociEAt6cIMFlIC0CUEl6l7JiNIzVrG1h4ReqhvY2zrmsjvDK7bWpr9ZCk5sJse7tSNaTtJK8QP2vE';
 ...
 *
 */
function createNotificationSubscription(): Promise<
    ServiceWorkerRegistration | PushSubscription
> {
 ...
 */
function getUserSubscription(): Promise<
    ServiceWorkerRegistration | PushSubscription | null
> {
    // wait for service worker installation to be ready, and then
